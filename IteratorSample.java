public class IteratorSample {
    public static void main(String[] args) {
        ...
        gameListAggregate.add(new Game("羅生門", "芥川龍之介"));
        gameListAggregate.add(new Game("少年の日の思い出", "ヘルマン・ヘッセ"));
        gameListAggregate.add(new Game("モチモチの木", "斎藤隆介"));
        gameListAggregate.add(new Game("走れメロス", "太宰治"));
        iterator.first();
